	...
	<div class="row">
		<div class="span4 offset4 well">
			...
			<div style="padding-top:5px;">
				...
				<label>
					<a href="<?php echo base_url(); ?>admin/signup"><?php echo $this->lang->line('create_an_php_pro_account')?></a>
				</label>
				<?php }?>
			</div>
			</form> 
        ...
        buttons: [{
            ...
            click: function(id, data) {
            	if (step == 1){
	            	...
	            	$.post('<?php echo base_url(); ?>admin/send_reset_password_link',{user_email:$('#'+id).find('#user_email').val()},function(o){
	            		if (o.send_link == 1){
