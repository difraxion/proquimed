<div class="container">
        ...
        <ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 0px;">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>admin/language/index"> <?php echo $this->lang->line('language_manager'); ?> </a></li>
        </ul>
</div>
...
<script>
function back() {
    window.location = "<?php echo base_url(); ?>admin/language/index?xtype=index";
}
