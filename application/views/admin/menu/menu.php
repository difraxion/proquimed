            ...
            <div class="nav-collapse collapse">
                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown   <?php if ($type == 'account') { ?>active<?php } ?>">
                        ...
                        <ul class="dropdown-menu">
                        	<?php if ($auth->isSettingManagement()){?>
							<li><a href="<?php echo base_url(); ?>admin/setting/index"> <i class="icon-cog"></i> <?php echo $this->lang->line('settings');?></a></li>
							<?php } ?>
                            <?php if ($CRUD_AUTH['group']['group_name'] != 'SystemAdmin') { ?>
                                ...
                                <li class="divider"></li>
                            <?php } ?>
                            <li><a href="<?php echo base_url(); ?>admin/logout"> <i class="icon-minus-sign"></i> <?php echo $this->lang->line('log_out');?></a></li>
                        </ul>
                    </li>
                </ul>
            </div>
