...
<div class="container">
        ...
        <ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 10px;">
            ...
            <li><a href="<?php echo base_url(); ?>admin/user/user"> &nbsp; <?php echo $this->lang->line('users');?> &nbsp; </a></li>
            <li><a href="<?php echo base_url(); ?>admin/user/group"><?php echo $this->lang->line('groups');?></a></li>
            <li  class="active"><a href="<?php echo base_url(); ?>admin/user/permission"><?php echo $this->lang->line('permissions');?></a></li>
          <?php } ?>
        </ul>
        
         <ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 10px;">
         	<li><a href="<?php echo base_url(); ?>admin/user/permission"><?php echo $this->lang->line('group_permissions');?></a></li>
         	<li class="active" ><a href="<?php echo base_url(); ?>admin/user/user_permission"><?php echo $this->lang->line('user_permissions');?></a></li>
         </ul>
         <div>
...
$("#user_permission").select2({
    ...
    ajax: {
        url: "<?php echo base_url(); ?>admin/user/user_json",
        dataType: 'jsonp',
...
$("#user_permission").on('change',function(e){
	$.get("<?php echo base_url(); ?>admin/user/user_json?id="+e.val,{},function(data){
