...
<div class="container">
        ...
        <ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 10px;">
         ...
         <ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 10px;">
         	<li class="active"><a href="<?php echo base_url(); ?>admin/user/permission"><?php echo $this->lang->line('group_permissions');?></a></li>
         	<li><a href="<?php echo base_url(); ?>admin/user/user_permission"><?php echo $this->lang->line('user_permissions');?></a></li>
         </ul>
        <div>
            <div>
...
<script>
    $(document).ready(function(){
        ...
        $('#btn_save').click(function(){
            ...
            $.post('<?php echo base_url(); ?>admin/user/savePermission', {data:data}, function(html){
