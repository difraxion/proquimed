		...
		<div id="tab_user_manager" class="row-fluid show-grid">
			<div class="span12">
				<ul class="nav nav-tabs" style="margin-bottom: 0px;">
					<li class="active"><a href="<?php echo base_url(); ?>admin/setting/index"><?php echo $this->lang->line('general');?></a>
					</li>
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li>
								<a href="<?php echo base_url(); ?>admin/setting/email/new_user"><?php echo $this->lang->line('new_user'); ?></a>
							</li>
							<li><a href="<?php echo base_url(); ?>admin/setting/email/reset_password"><?php echo $this->lang->line('reset_password'); ?></a>
							</li>
						</ul>
					</li>
				</ul>
...
function save_setting(){
	$.post('<?php echo base_url(); ?>admin/setting/save',$('#SettingSaveForm').serialize(),function(o){
		if (o.error == 0){
