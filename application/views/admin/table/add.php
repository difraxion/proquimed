...
?>
<div class="container" >
		<h2><?php echo $this->lang->line('tools_table_builder'); ?>	</h2>
        <ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 10px;">
            <li><a href="<?php echo base_url(); ?>admin/component/builder"> <?php echo $this->lang->line('components'); ?> </a></li>
            <li><a href="<?php echo base_url(); ?>admin/component/groups"> <?php echo $this->lang->line('group_component'); ?> </a></li>
            <li class="active"><a href="<?php echo base_url(); ?>admin/table/index"><?php echo $this->lang->line('table_builder'); ?></a></li>
            <li><a href="<?php echo base_url(); ?>admin/language/index"> <?php echo $this->lang->line('language_manager'); ?> </a></li>
        </ul>
        <h3 style="margin-top: 7px;"><?php if ($editFlag == true) { ?><?php echo $this->lang->line('edit'); ?><?php } else { ?><?php echo $this->lang->line('create'); ?><?php } ?> <?php echo $this->lang->line('table'); ?></h3>
        ...
        <form class="form-horizontal" id="frm_new_table">
            ...
            <div class="control-group" style="margin-bottom: 8px !important;">
                <label class="control-label" for="table_name"><?php echo $this->lang->line('table_name'); ?></label>
                <div class="controls">
                    <input type="text" id="table_name" name="table_name" placeholder="<?php echo $this->lang->line('table_name'); ?>">
                </div>
            </div>
            <div class="control-group" style="margin-bottom: 8px !important;">
                <label class="control-label" for="storage_engine"><?php echo $this->lang->line('storage_engine'); ?></label>
                <div class="controls">
            ...
            <div class="control-group" style="margin-bottom: 8px !important;">
                <label class="control-label" for="collation"><?php echo $this->lang->line('collation'); ?></label>
                <div class="controls">
            ...
            <div class="control-group" style="margin-bottom: 8px !important;">
                <label class="control-label" for="table_comment"><?php echo $this->lang->line('table_comments'); ?></label>
                <div class="controls">
                    <input type="text" id="table_comment" name="table_comment" placeholder="<?php echo $this->lang->line('table_comments'); ?>" class="input-xxlarge">
                </div>
            </div>
            <table class="table table-bordered list table-condensed" id="crud_table">
                ...
                <tr style="display:none;" id="template">
                    ...
                    <td style="text-align: center;">
                        <a class="btn btn-info btn-mini" onclick="add_field(this);"><?php echo $this->lang->line('add'); ?></a>
                        <a class="btn btn-danger btn-mini" onclick="delete_field(this);"><?php echo $this->lang->line('delete'); ?></a>
                    </td>
                </tr>
            ...
            <?php if ($editFlag == true){ ?>
                ...
                <?php echo $this->lang->line('config_of_this_table_will_be_removed'); ?>
                </p>
            <?php } ?>
            <div style="text-align: center;">
                <input type="button" class="btn" value="<?php echo $this->lang->line('cancel'); ?>" onclick="cancel();"/>
                <?php if ($editFlag == true) { ?>
                    <input type="button" class="btn btn-info" value=" <?php echo $this->lang->line('save'); ?> " onclick="updateTable();" />
                <?php } else { ?>
                    <input type="button" class="btn btn-info" value=" <?php echo $this->lang->line('save'); ?> " onclick="createNewTable();" />
                <?php } ?>
            </div>
        </form>
</div>
...
<script>
    ...
    function cancel(){
        window.location = '<?php echo base_url(); ?>admin/table/index';
    }
    ...
    function createNewTable(){
        ...
        $.post('<?php echo base_url(); ?>admin/table/insert', obj, function(o){
            if (o.error == 1){
    ...
    function updateTable(){
        ...
        $.post('<?php echo base_url(); ?>admin/table/update', obj, function(o){
            if (o.error == 1){
                var objError = $('<div class="alert alert-error"></div>');
                objError.append('<button data-dismiss="alert" class="close" type="button">×</button>');
                if (o.messages.length >0){
