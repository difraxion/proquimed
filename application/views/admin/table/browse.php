    ...
    <div data-spy="affix" data-offset-top="90" style="
        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div style="text-align:right;width:100%;">
                <a class="btn btn-info" href="<?php echo base_url(); ?>admin/table/form"><i class="icon-plus icon-white"></i> <?php echo $this->lang->line('add_table'); ?></a>
            </div>
        </div>
    </div>
 </div>
...
<script>
    ...
    function edit_table(table){
        window.location = '<?php echo base_url(); ?>admin/table/form?table='+table;
    }
    function delete_table(table){
        $.post('<?php echo base_url(); ?>admin/table/delete', {table:table}, function(data){
            $('#delModal').modal('hide');
