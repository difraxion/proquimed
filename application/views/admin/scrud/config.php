...
<script type="text/javascript">
    ...
    ScrudCForm.urlSaveConfig = '<?php echo base_url(); ?>admin/scrud/saveConfig';
    ...
    <div data-spy="affix" data-offset-top="86" style="
        ...
        <div class="container" style="border-bottom: 1px solid #CCC; padding-bottom:5px;padding-top:5px;
            ...
            <div style="text-align:right;width:100%;" id="form_toolbar" >
                ...
                <a class="btn" href="<?php echo base_url(); ?>admin/component/builder?xtype=index"> <i class="icon-arrow-left"></i> <?php echo $this->lang->line('back'); ?></a>
