<div style="padding:2px 8px 7px 8px; 
    ...
    <p><b>Congratulations</b>, you have successfully installed the CodeIgniter Admin Pro. <a href="<?php echo base_url(); ?>admin/login">Click here</a>  to login with users below.</p>
    <br />
